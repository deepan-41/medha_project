...
export default function WhiteLabelHover({onMouseEnter,onMouseLeave}){
    return(
        <>
            <section className="flex p-5 shadow-2xl rounded-b-2xl z-10"
                onMouseEnter={() => onMouseEnter("WhiteLabel")}
                ...
                <div className="grid grid-cols-2 gap-10 mt-5">
                    <div className="flex gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700">
                                Join our white label partner ecosystem
                            </p>
                            <Link 
                                to="/white-label-msp-services/partner-program"
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700">
                                24/7 white label IT support and management
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700">
                                24/7 network monitoring, security operations and cloud management
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700">
                                Expert technical teams on demand
                            </p>
                        </div>
                    </div>
                </div>
