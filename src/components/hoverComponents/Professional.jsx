...
export default function ProfessionalServiceHover({onMouseEnter,onMouseLeave}){
    return(
        <>
            <section 
                className="flex p-5 shadow-2xl rounded-b-2xl z-10 justify-between"
                onMouseEnter={() =>onMouseEnter("Professional")}
                onMouseLeave={onMouseLeave}
            >
                <div className="grid grid-cols-2 gap-10 mt-5">
                    <div className="flex gap-3 mr-40">
                        <div className="bg-green-700 h-10 w-10 flex items-center justify-center rounded-2xl" >
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-sm text-gray-700">
                                Expert Windows, Linux and platform support
                            </p>
                        </div>
                    </div>
                ...
                <div className="w-3/12  h-90 rounded-r-3xl shadow-2xl bg-green-700 text-white  flex  flex-col items-center justify-center">
                    ...
                    <p className="text-sm w-8/12 mb-5">
                        Strategic guide to professional IT services
                    </p>
