    ...
    return (
        <>
            <section className="flex flex-col items-center justify-center text-center p-30" >
                <h1 className="font-bold text-5xl">White Label Managed Services for MSPs</h1>
                <h1 className="text-xl mt-5 mb-8 text-gray-800 w-150">White label MSP services — we answer tickets, monitor servers, and handle incidents under your brand. Our MSP helpdesk, MSP NOC services, and service desk outsourcing let you scale without hiring.</h1>
            ...
            <section className="flex flex-col items-center justify-center text-center bg-gray-100 pt-25 pb-20">
                <h1 className="font-bold text-4xl w-full">Outsourced NOC, SOC & Helpdesk — Trusted by MSPs Worldwide</h1>
                <h1 className="text-xl mt-5 mb-8 text-gray-800 w-190">MSPs worldwide use our managed NOC and 24/7 NOC services from Bangalore—5X cheaper than onshore, invisible to their clients</h1>
